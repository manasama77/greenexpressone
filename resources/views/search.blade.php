                        ...
                        <div class="card-body">
                            ...
                            <form id="form_booking">
                                <div class="row">
                                    <div class="col-sm-12 col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2 w-100" id="from_master_area_id"
                                                name="from_master_area_id" data-placeholder="From/Departure" required
                                                disabled>
                                                <option value=""></option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label for="to_master_area_id"
                                                class="form-text font-weight-bold">To/Arrival</label>
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                        <div class="form-group">
                                            <label for="" class="form-text font-weight-bold">Booking Type</label>
                                            <div class="form-check form-check-inline">
                                                <input {{ $request->booking_type == 'shuttle' ? 'checked' : null }}
                                                    class="form-check-input" type="radio" name="booking_type"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" id="date_departure"
                                                name="date_departure" value="{{ $request->date_departure }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="number" class="form-control" id="passanger_adult"
                                                    ...
                                                    placeholder="Adult Passangers" min="1" max="9"
                                                    value="1" required />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="number" class="form-control" id="passanger_baby"
                                                    ...
                                                    placeholder="Adult Passangers" min="0" max="9"
                                                    value="0" required />
                                                <div class="input-group-append bg-light">
